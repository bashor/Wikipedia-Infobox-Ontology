...
public class Wiki implements Serializable
{
     ...
     *
     *  <pre>
     *  * [[ru.aptu.bashor.Main Page]]
     *  * [[Wikipedia:Featured picture candidates]]
     *  * [[:File:Example.png]]
     *  </pre>
     *
     *  in which case <tt>{ "ru.aptu.bashor.Main Page", "Wikipedia:Featured picture
     ...
     *  of <tt>parseList()</tt>, i.e. { "ru.aptu.bashor.Main Page", "Wikipedia:Featured
    ...
    public HashMap<String, String> getInterwikiLinks(String title) throws IOException
    {
        ...
        // parse the list
        // typical form: <ll lang="en" />ru.aptu.bashor.Main Page</ll>
    ...
    public String[][] search(String search, int... namespaces) throws IOException
    {
        ...
        while (!done)
        {
            ...
            // typical form: <p ns="0" title="ru.aptu.bashor.Main Page" snippet="Blah blah blah" sectiontitle="Section"/>
    ...
    public ArrayList[] linksearch(String pattern, int namespace, String protocol) throws IOException
    {
        ...
        while (!done)
        {
            ...
            // parse
            // typical form: <eu ns="0" title="ru.aptu.bashor.Main Page" url="http://example.com" />
            for (int x = line.indexOf("title=\""); x >= 0; x = line.indexOf("title=\"", x))
            {
